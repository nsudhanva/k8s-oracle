---
title: Recreate OKE Cluster from Scratch - Disaster Recovery
description: Complete guide to destroy and recreate OKE cluster on OCI. Terraform state management, data backup, and GitOps recovery procedures.
---
