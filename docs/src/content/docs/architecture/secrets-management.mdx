...
description: Secure secrets management for OKE using OCI Vault and External Secrets Operator. Sync secrets from Oracle Cloud Vault to Kubernetes with Instance Principals authentication.
---
...
| `gog-keyring-password` | gogcli keyring encryption password | OpenClaw |
