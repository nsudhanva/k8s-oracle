...
| `llama-server` | `ghcr.io/nsudhanva/llama-server:latest` | LLM inference | 2-4 GB, 1-1.8 CPU |
...
| CPU Request | 1 core | Dedicated compute |
| CPU Limit | 1.8 cores | Burst capacity |
...
quadrantChart
    ...
    quadrant-1 Ideal for Free Tier
