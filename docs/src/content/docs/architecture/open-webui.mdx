...
| **Gemma Integration** | Pre-configured to use Gemma 4 E2B |
...
Total cluster: 4 OCPUs, 24 GB RAM. Open WebUI uses up to ~4 GB RAM and 2 CPUs (burst), leaving enough headroom for Gemma (6 GB limit) and system components.
</Aside>
